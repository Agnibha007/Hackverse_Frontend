...
export function MissionCard({ mission, onUpdate, onDelete, onActivate }) {
...
export function FocusSessionForm({ onSubmit, isLoading }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    onSubmit({ duration_minutes: parseInt(duration), focus_quality: focusQuality, notes: notes || undefined });
    setDuration(25);
    setNotes("");
  };
