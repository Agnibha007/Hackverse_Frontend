...
The Neon Drive frontend is a React application built with Vite, providing a high-performance UI for the study dashboard. The app uses Zustand for state management and TailwindCSS for styling with custom neon components.
